...
log_path <- "inputs/main_combined_checks_eth_msna.xlsx"
...
df_cleaning_log <- readxl::read_excel(log_path, sheet = "cleaning_log") %>%  
...
# import clean data
clean_data_path <- "inputs/ETH2403_eth_msna_cleaned_data.xlsx"
...
saveWorkbook(wb_log, paste0("outputs/", butteR::date_file_prefix(),
                            "_ETH2403_MSNA_logbook.xlsx"), overwrite = TRUE)

openXL(file = paste0("outputs/", butteR::date_file_prefix(),"_ETH2403_MSNA_logbook.xlsx"))

# renamed file
saveWorkbook(wb_log, paste0("outputs/ETH2403_MSNA_logbook.xlsx"), overwrite = TRUE)
